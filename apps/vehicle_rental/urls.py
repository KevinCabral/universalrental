...
urlpatterns = [
    ...
    path('vehicles/inactive/', views.vehicle_inactive_list, name='vehicle_inactive_list'),
    path('vehicles/calendar/', views.rental_calendar, name='rental_calendar'),
    path('vehicles/create/', views.vehicle_create, name='vehicle_create'),
    path('vehicles/<int:pk>/', views.vehicle_detail, name='vehicle_detail'),
    path('vehicles/<int:pk>/edit/', views.vehicle_edit, name='vehicle_edit'),
    path('vehicles/<int:pk>/deactivate/', views.vehicle_deactivate, name='vehicle_deactivate'),
    path('vehicles/<int:pk>/activate/', views.vehicle_activate, name='vehicle_activate'),
